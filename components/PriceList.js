        ...
        <>
            ...
            <div className='container mt-5'>
                <motion.div
                    ...
                    className="row mb-4">
                    <h1 
                        className="text-center p-3 bg-danger shadow-lg rounded-4 text-white">
                ...
                >
                    ...
                    <div className="col-md-5 text-center mt-5">
                        ...
                        <div>
                            ...
                            <motion.div className='card bg-warning rounded-4 p-3 shadow-lg'
                                whileHover={{ 
                                    scale: 1.1,
                                    textShadow: "0px 0px 8px white",
                                }}
                ...
                <motion.div className='row my-5 w-75 mx-auto'
                    whileHover={{ 
                        scale: 1.05,
                ...
                >
                    <div className="card bg-danger shadow-lg rounded-5 p-3 text-center ">
                        <motion.h3 whileHover={{ scale: 1.1, textShadow: "0px 0px 8px white",}} className='p-3 bg-warning text-danger fw-semibold w-50 rounded-5 mx-auto '>BONUS ON IN</motion.h3>
